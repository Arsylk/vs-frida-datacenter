import * as DEF from './LinuxArm64Flags.js';
import { TypedData } from './TypedData.js';
import { L, type SyscallSignature } from './types.js';
...
RET.VADDR = {
    ...
    n: 'addr',
    l: L.VADDR,
    e: [E.EACCES, E.EAGAIN, E.EBADF, E.EINVAL, E.ENFILE, E.ENODEV, E.ENOMEM, E.ETXTBSY],
};
RET.SET_XATTR = {
    t: T.INT32,
    e: RET.STAT.e.concat([E.EDQUOT, E.EEXIST, E.ENODATA, E.ENOSPC, E.ENOTSUP, E.EPERM, E.ERANGE]),
};
...
export const SVC: SyscallSignature[] = [
    [
        ...
        0x00,
        [
            { t: T.UINT32, n: 'nr_reqs' },
            { t: T.POINTER64, n: 'aio_context_t *ctx' },
        ],
    ],
    ...
    [
        ...
        'io_submit',
        0x02,
        [A.AIO, { t: T.LONG, n: 'nr' }, { t: T.POINTER64, n: 'struct iocb **iocbpp' }],
        RET.IO,
    ],
    ...
    [
        ...
        [
            A.AIO,
            { t: T.LONG, n: 'long min_nr' },
            { t: T.LONG, n: 'nr' },
            A.IOEV.copy('*events'),
            A.KERNEL_TIMESPEC.copy('timeout'),
        ],
        RET.IO,
    ],
    ...
    [
        ...
        'getcwd',
        0x11,
        [{ t: T.CHAR_BUFFER, n: 'path_buff', l: L.PATH }, A.SIZE],
        {
            t: T.CHAR_BUFFER,
            n: 'path_buff',
            l: L.PATH,
            e: [E.EACCES, E.EFAULT, E.EINVAL, E.ENOENT, E.ERANGE],
        },
    ],
    [
        18,
        'lookup_dcookie',
        0x12,
        [{ t: T.ULONG, n: 'cookie64' }, { t: T.CHAR_BUFFER, n: 'buffer', l: L.XATTR_LIST, r: 2 }, A.SIZE],
    ],
    [
        19,
        'eventfd2',
    ...
    [
        ...
        [
            A.EPFD,
            A.EPEV,
            { t: T.INT32, n: 'maxevents' },
            { t: T.INT32, n: 'timeout' },
            A.SIGSET.copy('*sigmask').constant(true),
        ],
    ],
    [
        23,
        ...
        0x17,
        [A.FD],
        { t: T.UINT32, n: 'fd', l: L.FD, e: [E.EBADF, E.EBUSY, E.EINTR, E.EINVAL, E.EMFILE] },
    ],
    [
        24,
        'dup3',
        0x18,
        [
            { t: T.UINT32, n: 'old_fd', l: L.FD },
            { t: T.UINT32, n: 'old_fd', l: L.FD },
            { t: T.INT32, n: 'flags', l: L.FLAG },
        ],
        { t: T.UINT32, n: 'fd', l: L.FD, e: [E.EBADF, E.EBUSY, E.EINTR, E.EINVAL, E.EMFILE] },
    ],
    [
        ...
        [
            A.FD,
            { t: T.UINT32, n: 'cmd', l: L.FLAG, f: X.FNCTL },
            { t: T.ULONG, n: 'args', l: L.FLAG, r: 'x1', f: X.FCNTL_ARGS },
        ],
        { t: T.INT32, n: 'ret', r: 'x1', l: L.FLAG, f: X.FCNTL_RET, e: [] },
    ],
    [
        26,
        'inotify_init1',
        0x1a,
        [{ t: T.INT32, n: 'flags', l: L.FLAG, f: X.INOTIFY_FLAGS }],
        { t: T.INT32, e: [E.EMFILE, E.EINVAL, E.ENFILE, E.ENOMEM] },
    ],
    [
        27,
        'inotify_add_watch',
        0x1b,
        [A.FD, A.CONST_PATH, { t: T.UINT32, n: 'mask', l: L.FLAG, f: X.INOTIFY_MASK }],
        A.WD.asReturn([
            E.EACCES,
            E.EBADF,
            E.EEXIST,
    ...
    [
        ...
        [
            A.DFD,
            A.CONST_NAME,
            { t: T.INT32, n: 'umode', l: L.FLAG, f: X.NODMODE, r: 'x3' },
            { t: T.INT32, n: 'dev', l: L.DEV },
        ],
    ],
    ...
    [
        ...
        [
            ...
            A.NEW_DFD,
            { t: T.POINTER64, n: 'value' },
            { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.LINKAT },
        ],
        RET.LINKAT,
    ],
    [
        ...
        'renameat',
        0x26,
        [A.OLD_DFD, A.CONST_NAME.copy('oldname'), A.NEW_DFD, A.CONST_NAME.copy('newname')],
    ],
    [
        39,
        'umount2',
        0x27,
        [A.CONST_PATH /* target */, { t: T.INT32, n: 'flags', l: L.FLAG, f: X.UMOUNT, c: true }],
    ],
    [
        40,
        'mount',
        ...
        [
            ...
            A.STR.copy('dir_name'),
            A.STR.copy('type'),
            { t: T.ULONG, n: 'flags', l: L.FLAG, f: X.MOUNT_FLAG },
            { t: T.POINTER64, n: '*dat' },
        ],
    ],
    ...
    [
        ...
        0x2a,
        [
            { t: T.INT32, n: 'REMOVED cmd' },
            { t: T.POINTER64, n: 'struct nfsctl_arg *argp' },
            { t: T.POINTER64, n: 'union nfsctl_res *resp' },
        ],
    ], // REMOVED since 3.1
    ...
    [
        ...
        {
            t: T.INT32,
            e: [E.EACCES, E.EFAULT, E.EIO, E.ELOOP, E.ENAMETOOLONG, E.ENOENT, E.ENOMEM, E.ENOTDIR, E.EPERM],
        },
    ],
    [
        52,
        'fchmod',
        0x34,
        [A.FD, { t: T.USHORT, n: 'mode', l: L.ATTRMODE, f: X.ATTR }],
        {
            t: T.INT32,
            e: [
                E.EACCES,
    ...
    [
        ...
        0x3b,
        [
            { t: T.POINTER64, n: 'pipefd', l: L.PIPEFD },
            { t: T.INT32, n: 'flags', l: L.FLAG, f: X.PIPE_FLAG },
        ],
    ],
    ...
    [
        ...
        [
            ...
            { t: T.POINTER64, n: 'linux_dirent64 *dirent', l: L.DSTRUCT, f: 'linux_dirent64' },
            A.SIZE,
        ],
    ],
    ...
    [
        ...
        'read',
        0x3f,
        [A.FD, A.OUTPUT_CHAR_BUFFER, { t: T.UINT32, n: 'count', l: L.SIZE }],
        { t: T.UINT32, r: 1, n: 'sz', l: L.SIZE, e: [] },
    ],
    ...
    [
        ...
        [
            { t: T.INT32, n: 'nfds' },
            A.FD_SET.copy('readfds'),
            A.FD_SET.copy('writefds'),
            A.FD_SET.copy('exceptfds'),
            A.KERNEL_TIMESPEC,
            A.SIGSET.copy('*sigmask').constant(true),
        ],
    ],
    [
        ...
        'ppoll',
        0x49,
        [A.POLLFD, A.SIZE.copy('nfds'), A.KERNEL_TIMESPEC, A.SIGSET.copy('*sigmask').constant(true)],
    ],
    [
        74,
        'signalfd4',
        ...
        [
            A.FD,
            A.SIGSET.copy('*user_mask'),
            A.SIZE.copy('sizemask'),
            { t: T.INT32, n: 'flags', l: L.FLAG, f: X.SFD },
        ],
    ],
    [
        75,
        'vmsplice',
        0x4b,
        [A.FD, A.IOVEC, A.LEN.copy('nr_segs'), { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.SPLICE }],
    ],
    [
        76,
        'splice',
        0x4c,
        [
            { t: T.UINT32, n: 'fd_in', l: L.FD },
            A.LOFFSET.copy('*off_in'),
            { t: T.UINT32, n: 'fd_out', l: L.FD },
            A.LOFFSET.copy('*off_out'),
            A.SIZE,
            'unsigned int flags[',
        ],
    ],
    ...
    [
        ...
        'readlinkat',
        0x4e,
        [A.DFD, { t: T.STRING, n: 'path', l: L.PATH, c: true }, A.OUTPUT_CHAR_BUFFER, A.SIZE],
    ],
    [
        79,
        'newfstatat',
        0x4f,
        [A.DFD, { t: T.STRING, n: 'filename', c: true }, A.STATBUF, A.ACCESS_FLAGS],
        RET.ACCESS,
    ],
    ...
    [
        ...
        'sync_file_range',
        0x54,
        [A.FD, A.LOFFSET, A.LEN.copy('nbytes'), { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.SYNC_FILE }],
    ],
    [
        85,
        'timerfd_create',
        0x55,
        [A.CLKID, { t: T.INT32, n: 'flags', l: L.FLAG, f: X.TFD }],
        A.FD.asReturn([]),
    ],
    [
        86,
        ...
        [
            A.FD,
            { t: T.INT32, n: 'flags', l: L.FLAG, f: X.TIMER },
            A.CONST_KERNEL_TIMESPEC.copy('*new'),
            A.ITIMERSPEC.copy('*old'),
        ],
    ],
    ...
    [
        ...
        'utimensat',
        0x58,
        [A.DFD, { t: T.STRING, n: 'filename', c: true }, A.KERNEL_TIMESPEC.copy('utimes'), 'int flags'],
    ],
    ...
    [
        ...
        0x5f,
        [
            { t: T.INT32, n: 'type_id', l: L.FLAG, f: X.TYPEID },
            { t: T.UINT32, n: 'id' },
            A.SIGINFO,
            'int options',
            A.RUSAGE,
    ...
    [
        ...
        0x62,
        [
            { t: T.UINT32, n: 'word', l: L.FUTEX },
            { t: T.INT32, n: 'op', l: L.FLAG, f: X.FUTEX_OPE },
            'u32 val',
            A.KERNEL_TIMESPEC.copy('*utime'),
            'u32 *uaddr2',
            'u32 val3[',
        ],
    ],
    ...
    [
        ...
        'get_robust_list',
        0x64,
        [A.PID, { t: T.POINTER64, n: 'struct robust_list_head **head_ptr' }, 'size_t *len_ptr'],
    ],
    ...
    [
        ...
        'kexec_load',
        0x68,
        [{ t: T.ULONG, n: 'entry' }, 'unsigned long nr_segments', A.KEXSEG, 'unsigned long flags'],
    ],
    ...
    [
        ...
        'delete_module',
        0x6a,
        [A.CONST_NAME.copy('name_user'), { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.DEL_KEXT }],
    ],
    [
        107,
        'timer_create',
        0x6b,
        [A.CLKID, A.SIGEVENT.copy('*timer_event_spec'), A.TIMER_PTR.copy('created_timer_id')],
        { t: T.INT32, e: [E.EAGAIN, E.EINVAL, E.ENOMEM] },
    ],
    ...
    [
        ...
        'timer_settime',
        0x6e,
        [A.TIMER, 'int flags', A.ITIMERSPEC.copy('*new_setting'), A.ITIMERSPEC.copy('*old_settings')],
    ],
    ...
    [
        ...
        'clock_nanosleep',
        0x73,
        [A.CLKID, 'int flags', A.CONST_KERNEL_TIMESPEC.copy('*rqtp'), A.KERNEL_TIMESPEC.copy('*rmtp')],
    ],
    ...
    [
        ...
        0x75,
        [
            { t: T.LONG, n: 'request', l: L.FLAG, f: X.PTRACE },
            { t: T.LONG, n: 'pid', l: L.PID },
            A.ADDR,
            { t: T.POINTER64, n: 'data', l: L.PTRACE, r: 'x1', f: X.PTRACE_DATA },
        ],
    ],
    ...
    [
        ...
        0x87,
        [
            { t: T.INT32, n: 'how', l: L.FLAG, f: X.SIG_FLAGS },
            A.SIGSET.copy('*set'),
            A.SIGSET.copy('*oset'),
            A.SIZE.copy('sigsetsize'),
        ],
    ],
    ...
    [
        ...
        0x89,
        [
            A.SIGSET.copy('*uthese').constant(true),
            A.SIGINFO,
            A.CONST_KERNEL_TIMESPEC.copy('*uts'),
            A.SIZE.copy('sigsetsize'),
        ],
    ],
    ...
    [
        ...
        0x91,
        [
            { t: T.UINT32, n: 'real_user', l: L.UID },
            { t: T.UINT32, n: 'effective_user', l: L.UID },
        ],
        RET.INFO,
    ],
    ...
    [
        ...
        0x94,
        [
            { t: T.POINTER64, n: 'real_user', l: L.UID },
            { t: T.POINTER64, n: 'effective_user', l: L.UID },
            { t: T.POINTER64, n: 'suid', l: L.UID },
        ],
    ],
    [
        149,
        ...
        0x95,
        [
            { t: T.UINT32, n: 'real_grp', l: L.GID },
            { t: T.UINT32, n: 'effective_grp', l: L.GID },
            { t: T.UINT32, n: 'sgid', l: L.GID },
        ],
        RET.INFO,
    ],
    [
        ...
        0x96,
        [
            { t: T.POINTER64, n: 'real_grp', l: L.UID },
            { t: T.POINTER64, n: 'effective_grp', l: L.UID },
            { t: T.POINTER64, n: 'sgid', l: L.UID },
        ],
        RET.INFO,
    ],
    ...
    [157, 'setsid', 0x9d, [], undefined, RET.INFO],
    ...
    [
        ...
        0xa7,
        [
            { t: T.INT32, n: 'opt', l: L.FLAG, f: X.PRCTL_OPT },
            { t: T.ULONG, n: 'arg2' },
            { t: T.ULONG, n: 'arg3' },
            { t: T.ULONG, n: 'arg4' },
            { t: T.ULONG, n: 'arg5' },
    ...
    [
        ...
        'getcpu',
        0xa8,
        [{ t: T.POINTER64, n: ' *cpu' }, { t: T.POINTER64, n: ' *node' }, A.GPU_CACHE],
        RET.FAULT,
    ],
    ...
    [
        ...
        [
            A.MQD,
            A.CONST_NAME.copy('*msg_ptr'),
            A.SIZE.copy('msg_len'),
            { t: T.UINT32, n: 'msg_prio' },
            A.CONST_KERNEL_TIMESPEC.copy('*abs_timeout'),
        ],
    ],
    [
        183,
        ...
        [
            A.MQD,
            A.OUTPUT_CHAR_BUFFER.copy('*msg_ptr'),
            A.SIZE.copy('msg_len'),
            { t: T.POINTER64, n: '*msg_prio' },
            A.CONST_KERNEL_TIMESPEC.copy('*abs_timeout'),
        ],
    ],
    ...
    [
        ...
        [
            A.MQID,
            { t: T.INT32, n: 'cmd', l: L.FLAG, f: X.MSGCTL },
            { t: T.POINTER64, n: 'msqid_ds', l: L.DSTRUCT, f: 'msqid_ds' },
        ],
    ],
    [
        188,
        ...
        [
            ...
            A.SIZE.copy('msgsz'),
            'long msgtyp',
            { t: T.INT32, n: 'msgflg', l: L.FLAG, f: X.MSGF },
        ],
    ],
    [
        189,
        'msgsnd',
        0xbd,
        [A.MQID, A.MSGBUF, A.SIZE.copy('msgsz'), { t: T.INT32, n: 'msgflg', l: L.FLAG, f: X.MSGF }],
    ],
    ...
    [
        ...
        'semtimedop',
        0xc0,
        [A.SEMID, A.SEMBUF, 'unsigned nsops', A.CONST_KERNEL_TIMESPEC.copy('*timeout')],
    ],
    ...
    [
        ...
        0xc6,
        [
            { t: T.INT32, n: 'domain', l: L.FLAG, f: X.PF },
            { t: T.INT32, n: 'type', l: L.FLAG, f: X.SOCK },
            'int',
        ],
        A.SOCKFD.asReturn([
            /* TODO */
    ...
    [
        ...
        'mremap',
        0xd8,
        [A.ADDR, 'unsigned long old_len', 'unsigned long new_len', 'unsigned long flags', A.ADDR],
    ],
    [
        217,
        'add_key',
        0xd9,
        [
            A.CONST_NAME.copy('*type'),
            A.CONST_NAME.copy('*description'),
            'const void *_payload',
            A.SIZE.copy('plen'),
    ...
    [
        ...
        [
            A.CONST_NAME.copy('*type'),
            A.CONST_NAME.copy('*description'),
            A.CONST_NAME.copy('*callout_info'),
            'key_serial_t destringid',
        ],
    ],
    [
    ...
    [
        ...
        0xdd,
        [
            { t: T.STRING, n: 'filename', c: true },
            { t: T.STRING, n: '*argv', c: true },
            { t: T.STRING, n: '*envp', c: true },
        ],
    ],
    [
        222,
        ...
        [
            ...
            A.SIZE,
            A.MPROT,
            { t: T.INT32, n: 'flags', l: L.FLAG, f: X.MAP },
            { t: T.UINT32, n: 'fd', l: L.MFD },
            A.OFFSET,
        ],
        RET.VADDR,
    ],
    ...
    [
        ...
        'mprotect',
        0xe2,
        [A.ADDR, A.SIZE, A.MPROT],
        { t: T.INT32, e: [E.EACCES, E.EFAULT, E.EINVAL, E.ENOMEM] },
    ],
    [
        227,
        'msync',
        0xe3,
        [A.ADDR, A.SIZE, { t: T.ULONG, n: 'flags', l: L.FLAG, f: X.MS }],
        { t: T.INT32, e: [E.EBUSY, E.EINVAL, E.ENOMEM] },
    ],
    ...
    [
        ...
        'mlockall',
        0xe6,
        [{ t: T.INT32, n: 'flags', l: L.FLAG, f: X.MCL }],
        { t: T.INT32, e: [E.EPERM, E.EINVAL, E.ENOMEM] },
    ],
    ...
    [
        ...
        'madvise',
        0xe9,
        [A.ADDR, A.SIZE, { t: T.INT32, n: 'behavior', l: L.FLAG, f: X.MADV }],
        { t: T.INT32, e: [E.EAGAIN, E.EBADF, E.EINVAL, E.EIO, E.ENOMEM] },
    ],
    [
        234,
        'remap_file_pages',
        0xea,
        [A.START_ADDR, A.LEN, 'unsigned long prot', 'unsigned long pgoff', 'unsigned long flags'],
    ],
    [
        235,
        'mbind',
    ...
    [
        ...
        'perf_event_open',
        0xf1,
        [A.PERFEVTATTR, { t: T.INT32, n: 'pid', l: L.PID }, 'int cpu', 'int group_fd', 'unsigned long flags'],
    ],
    [
        242,
        'accept4',
        0xf2,
        [A.SOCKFD, A.SOCKADDR, A.SIZE.out(), { t: T.INT32, n: 'type', l: L.FLAG, f: X.SOCKF }],
    ],
    [
        243,
        'recvmmsg',
    ...
    [
        ...
        'sendmmsg',
        0x10d,
        [{ t: T.UINT32, n: 'fd', l: L.FD }, A.MMSGHDR, 'unsigned int vlen', 'unsigned flags'],
    ],
    [
        270,
        'process_vm_readv',
    ...
    [
        ...
        'kcmp',
        0x110,
        [A.PID.copy('pid1'), A.PID.copy('pid2'), 'int type', 'unsigned long idx1', 'unsigned long idx2'],
    ],
    [
        273,
        'finit_module',
        0x111,
        [{ t: T.UINT32, n: 'fd', l: L.FD }, A.CONST_NAME.copy('uargs'), 'int flags'],
    ],
    ...
    [
        ...
        0x115,
        [
            { t: T.UINT32, n: 'ope', l: L.FLAG, f: X.SECCOMP },
            { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.SECCOMP_FLAGS, r: 1 },
            'void *uargs',
        ],
    ],
    [
        ...
        'getrandom',
        0x116,
        [{ t: T.CHAR_BUFFER, n: 'buf', l: L.OUTPUT_BUFFER }, 'size_t count', 'unsigned int flags'],
    ],
    [
        279,
        'memfd_create',
        0x117,
        [
            { t: T.CHAR_BUFFER, n: 'filename', l: L.PATH },
            { t: T.UINT32, n: 'flags', l: L.FLAG, f: X.MFD },
        ],
        { t: T.UINT32, n: 'mfd', l: L.FD, e: [E.EFAULT, E.EINVAL, E.EMFILE, E.ENFILE, E.ENOMEM] },
    ],
    ...
    [
        ...
        [
            { t: T.INT32, n: 'dfd', l: L.DFD },
            { t: T.STRING, n: 'filename', c: true },
            A.CONST_NAME.copy('*argv'),
            A.CONST_NAME.copy('*envp'),
            'int flags',
        ],
    ],
    ...
    [
        ...
        0x11b,
        [
            { t: T.INT32, n: 'cmd', l: L.FLAG, f: X.MEMBARRIER_CMD },
            { t: T.INT32, n: 'glag', l: L.FLAG, f: X.MEMBARRIER_FLAG },
        ],
    ],
    ...
    [
        ...
        'pkey_alloc',
        0x121,
        ['unsigned long RESERVED flags', { t: T.ULONG, n: 'access_rights', l: L.FLAG, f: X.PKEY_ACL }],
        A.PKEY.asReturn(),
    ],
