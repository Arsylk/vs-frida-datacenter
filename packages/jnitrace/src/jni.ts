type JniMethodArgTypeString = 'double' | 'float' | 'int16' | 'int32' | 'int64' | 'int8' | 'pointer' | 'uint16' | 'uint8';
type JniMethodRetTypeString = 'double' | 'float' | 'int16' | 'int32' | 'int64' | 'int8' | 'pointer' | 'uint16' | 'uint8' | 'void';
...
const JNI = {
    NULL0: { jni: { ret: 'NULL', args: [] }, retType: 'void' as 'void', argTypes: [] as [] as [], name: 'NULL0', offset: 0 },
    NULL1: { jni: { ret: 'NULL', args: [] }, retType: 'void' as 'void', argTypes: [] as [] as [], name: 'NULL1', offset: 1 },
    NULL2: { jni: { ret: 'NULL', args: [] }, retType: 'void' as 'void', argTypes: [] as [] as [], name: 'NULL2', offset: 2 },
    NULL3: { jni: { ret: 'NULL', args: [] }, retType: 'void' as 'void', argTypes: [] as [] as [], name: 'NULL3', offset: 3 },
    GetVersion: { jni: { ret: 'jint', args: ['JNIEnv*'] }, retType: 'int32' as 'int32', argTypes: ['pointer'] as ['pointer'] as ['pointer'], name: 'GetVersion', offset: 4 },
    DefineClass: {
        jni: { ret: 'jclass', args: ['JNIEnv*', 'char*', 'jobject', 'jbyte*', 'jsize'] },
        retType: 'pointer' as 'pointer',
        argTypes: ['pointer', 'pointer', 'pointer', 'pointer', 'int32'] as ['pointer', 'pointer', 'pointer', 'pointer', 'int32'] as ['pointer', 'pointer', 'pointer', 'pointer', 'int32'],
        name: 'DefineClass',
        offset: 5,
    },
    FindClass: {
    ...
    ToReflectedMethod: {
        ...
        retType: 'pointer' as 'pointer',
        argTypes: ['pointer', 'pointer', 'pointer', 'uint8'] as ['pointer', 'pointer', 'pointer', 'uint8'] as ['pointer', 'pointer', 'pointer', 'uint8'],
    ...
    IsAssignableFrom: {
        ...
        retType: 'uint8' as 'uint8',
        argTypes: ['pointer', 'pointer', 'pointer'] as ['pointer', 'pointer', 'pointer'] as ['pointer', 'pointer', 'pointer'],
    ...
    ExceptionDescribe: {
        ...
        retType: 'void' as 'void',
        argTypes: ['pointer'] as ['pointer'],
        name: 'ExceptionDescribe',
        offset: 16,
    },
    ExceptionClear: { jni: { ret: 'void', args: ['JNIEnv*'] }, retType: 'void' as 'void', argTypes: ['pointer'] as ['pointer'], name: 'ExceptionClear', offset: 17 },
    FatalError: {
    ...
    NewObject: {
        ...
        retType: 'pointer' as 'pointer',
        argTypes: ['pointer', 'pointer', 'pointer', 'pointer'] as ['pointer', 'pointer', 'pointer', 'pointer'],
        name: 'NewObject',
        offset: 28,
    },
    NewObjectV: {
    ...
    CallNonvirtualObjectMethod: {
        ...
        retType: 'pointer' as 'pointer',
        argTypes: ['pointer', 'pointer', 'pointer', 'pointer', 'pointer'] as ['pointer', 'pointer', 'pointer', 'pointer', 'pointer'],
    ...
    GetBooleanArrayRegion: {
        ...
        retType: 'void' as 'void',
        argTypes: ['pointer', 'pointer', 'int32', 'int32', 'pointer'] as ['pointer', 'pointer', 'int32', 'int32', 'pointer'],
...
export { JNI, asFunction, JniMethodDefinition, jMethodID, jFieldID, jclass, jobject };
